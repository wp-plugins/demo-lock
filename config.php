...
/**Set Plugin Name*/
$demovars['plugin_title'] = 'My Plugin';
...
/**Add user roles to set restricted capabilties for*/
$demovars['role'] = array('subscriber');

/**Add Capabilities that will be applied to each of the above specified roles*/
$demovars['allow_capabilites'] = array( 'edit_theme_options', 'upload_files' );

/**Set which php files you want your demo users to be allowed to access*/
$demovars['allow_pages'] = array('index.php', 'wp-login.php', 'themes.php', 'admin-ajax.php');

/**Set the file name(s) that are used to directly access your plugin */
$demovars['plugin_file'] = array();

/**If you are restricting users to a page with a specific argument, such as themes.php?page=plugin_name, set the variable below in the format ['getvar']['page'] = 'plugin_name'; set as many getvars as you need */
$demovars['getvar']['page'] = 'my-plugin-page';
...
$demovars['remove_menu'] = array( __( 'Posts' ), __( 'Media' ), __( 'Comments' ), __( 'Profile' ), __( 'Tools' ), __( 'Appearance' ) );
